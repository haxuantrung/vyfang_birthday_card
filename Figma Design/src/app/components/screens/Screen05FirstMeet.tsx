...
export function Screen05FirstMeet() {
  return (
    <GalaxyBg variant="aurora" className="w-full h-full">
      ...
      <div className="absolute top-16 left-0 right-0 h-28 pointer-events-none overflow-hidden">
        <motion.div
      ...
      {/* Timeline cards */}
      <div className="absolute left-5 right-5 flex flex-col gap-3" style={{ top: "175px", bottom: "40px" }}>
        {TIMELINE.map((item, i) => (
          <motion.div
            key={i}
