...
const PHOTOS = [
  { id: 1, rotation: -8, x: -30, y: -20, scale: 0.88, label: "Lần đầu gặp nhau", color: "#C8A8FF", zIndex: 1, featured: false },
  { id: 2, rotation: 5, x: 35, y: -30, scale: 0.85, label: "Buổi sáng thứ 7", color: "#F6C6FF", zIndex: 2, featured: false },
  { id: 3, rotation: 0, x: 0, y: 0, scale: 1.1, label: "Em — 28 tuổi", color: "#E9DDFF", zIndex: 10, featured: true },
  { id: 4, rotation: -4, x: -40, y: 40, scale: 0.82, label: "Hồ Trị An", color: "#C5E1FF", zIndex: 3, featured: false },
  { id: 5, rotation: 7, x: 38, y: 45, scale: 0.84, label: "Chidori", color: "#C8A8FF", zIndex: 4, featured: false },
];
...
export function Screen10Polaroids() {
  return (
